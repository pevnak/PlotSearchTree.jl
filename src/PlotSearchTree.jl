...
using PDDL, SymbolicPlanners, StatsBase
...
"""
function plot_search_tree(io::IOStream, st::SearchTree, trajectory, hvals = Dict{UInt64, Float64}(); α = 1, β = 1, hspace = 1, vspace = 1, kwargs...)
